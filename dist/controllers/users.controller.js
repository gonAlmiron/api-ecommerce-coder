...
exports.signUpController = exports.loginController = exports.getAllController = void 0;
var _passport = _interopRequireDefault(require("passport"));
var _logger = _interopRequireDefault(require("../logs/logger.js"));
var _notifications = require("../services/notifications/notifications.js");
var _usersServices = require("../services/users.services.js");
...
var signUpController = function signUpController(req, res, next) {
  try {
    _passport["default"].authenticate('signup', _usersServices.passportOptions, function (err, user, info) {
      _logger["default"].info('Info SIGNUP');
      _logger["default"].info(err, user, info);
      if (err) {
        return next(err);
      }
      ...
      _notifications.transporter.sendMail({
...
var getAllController = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return (0, _usersServices.getAllUsers)();
        case 3:
          users = _context.sent;
        ...
        case 7:
          ...
          res.status(501).send(_context.t0.message, _context.t0.stack);
        case 10:
        case "end":
  ...
  return function getAllController(_x, _x2) {
