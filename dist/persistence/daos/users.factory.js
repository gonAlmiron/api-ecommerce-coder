...
exports.updateById = exports.saveUser = exports.getUser = exports.getDao = exports.getById = exports.getByCategory = exports.getAll = exports.deleteById = void 0;
...
var selectedDao = 'mongo';
switch (selectedDao) {
  case 'mongo':
    dao = new _mongodb["default"]('user', _user.UserSchema);
    dao.initMongoDB();
    break;
  default:
    dao = new _mongodb["default"]('user', _user.UserSchema);
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(username, password) {
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.next = 2;
          return dao.save(username, password);
        case 2:
...
var deleteById = /*#__PURE__*/function () {
  ...
  return function deleteById(_x5) {
    return _ref5.apply(this, arguments);
  };
}();
exports.deleteById = deleteById;
var updateById = /*#__PURE__*/function () {
  var _ref6 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6(id, prod) {
    return _regeneratorRuntime().wrap(function _callee6$(_context6) {
      while (1) switch (_context6.prev = _context6.next) {
        case 0:
          _context6.next = 2;
          return dao.updateById(id, prod);
        case 2:
...
var getByCategory = /*#__PURE__*/function () {
  var _ref7 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee7(category) {
  ...
  return function getByCategory(_x8) {
