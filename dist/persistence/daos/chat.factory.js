...
exports.save = exports.getDao = exports.getAll = exports.deleteById = void 0;
var _logger = _interopRequireDefault(require("../../logs/logger"));
var _mongodb = _interopRequireDefault(require("./dao-MongoDB/mongodb"));
var _message = require("./dao-MongoDB/schemas/message.js");
...
switch (selectedDao) {
  case 'mongo':
    dao = new _mongodb["default"]('messages', _message.MessageSchema);
    dao.initMongoDB();
    break;
  default:
    dao = new _mongodb["default"]('messages', _message.MessageSchema);
