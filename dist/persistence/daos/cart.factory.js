...
exports.updateById = exports.save = exports.getDao = exports.getById = exports.getByCategory = exports.getAll = exports.deleteById = void 0;
var _mongodb = _interopRequireDefault(require("./dao-MongoDB/mongodb"));
var _cart = require("./dao-MongoDB/schemas/cart.js");
...
switch (selectedDao) {
  case 'mongo':
    dao = new _mongodb["default"]('cart', _cart.CartSchema);
    dao.initMongoDB();
    break;
  default:
    dao = new _mongodb["default"]('cart', _cart.CartSchema);
