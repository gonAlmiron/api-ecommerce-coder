...
exports.updateById = exports.save = exports.getDao = exports.getById = exports.getAll = exports.deleteById = void 0;
var _logger = _interopRequireDefault(require("../../logs/logger"));
var _mongodb = _interopRequireDefault(require("./dao-MongoDB/mongodb"));
var _category = require("./dao-MongoDB/schemas/category.js");
...
switch (selectedDao) {
  case 'mongo':
    dao = new _mongodb["default"]('category', _category.CategorySchema);
    dao.initMongoDB();
    break;
  default:
    dao = new _mongodb["default"]('category', _category.CategorySchema);
